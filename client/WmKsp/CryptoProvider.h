...
public:
	...
	virtual DWORD MakeRSAKey(BYTE* pBuffer, DWORD dwBufferSize, PDWORD pdwKeySize, int keyBits) = 0;
	virtual DWORD MakeEccKey(BYTE* pBuffer, DWORD dwBufferSize, PDWORD pdwKeySize, int keyBits) = 0;

	virtual DWORD ExportBCryptPubKeyBlob(
		PBYTE pKeyBlob,
		DWORD dwKeyBlobSize,
		PBYTE pOutBuffer,
		DWORD dwOutBufferSize,
		PDWORD pdwRequiredSize) = 0;

	virtual DWORD SignHash(
		PBYTE pKeyBlob,
		DWORD dwKeyBlobSize,
		PBYTE pHash,
		DWORD dwHashSize,
		...
		PDWORD pdwActualSignatureSize) = 0;
